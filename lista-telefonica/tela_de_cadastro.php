...
<main class="form-signin w-100 m-auto">
  <form action="teste_cadastro.php" method="POST" >
    <img class="mb-4" src="/img/icone-lista.png" alt="" width="72" height="70">
    <h1 class="h3 mb-3 fw-normal">Cadastre-se</h1>

    <div class="form-floating">
      <input type="text" class="form-control" id="floatingInput" placeholder="joaozinho" name="nome" >
      <label for="floatingInput">Nome <span>*</span></label>
    </div>
    ...
    <p class="mt-5 mb-3 text-body-secondary">&copy;  <a href="extra.php">2023</a></p>
  </form>
</main>
